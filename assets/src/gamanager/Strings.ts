module gamanager {
	export class Strings {
		public static ERROR_REQUEST_TIMEOUT: string = 'Promiň, ale někde se to zadrhlo. Zkus to prosím později.';
		public static ERROR_NOT_AUTHORIZED: string = 'Nepodařilo se autorizovat uživatele.';
		public static ERROR_PLUS_NOT_FOUND: string = 'Nepodařilo se stáhnout knihovnu Google+ k oveření uživatele.';
		public static ERROR_USER_DATA: string = 'Nepodařilo se stáhnou uživatelská data';
